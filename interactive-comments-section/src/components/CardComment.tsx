                ...
                <div className="mt-3">
                    {isEditing ? (
                        <textarea
                            ...
                            className="focus:ring-1 focus:ring-Purple-600 hover:bg-Purple-700 transition duration-200 ease-in-out w-full p-2 border border-gray-300 rounded focus:outline-none"
                        />
                    ) : (
